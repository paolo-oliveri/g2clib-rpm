...
This library contains "C" decoder/encoder
routines for GRIB edition 2.  The user API for the GRIB2 routines
is described in file "user_manual.md".
...
* Tue May 7  2024 Paolo Oliveri <paul@oliveri.info> - 1.6.4-0
- Rebuilt for RHEL 9

* Tue May 7  2024 Paolo Oliveri <paul@oliveri.info> - 1.9.0-0
- Updated to version 1.9.0 and built for Fedora 40

* Tue Apr 23 2024 Paolo Oliveri <paul@oliveri.info> - 1.6.4-0
- Updated to version 1.6.4 and rebuilt for RHEL 8

* Tue Feb 6  2024 Paolo Oliveri <paul@oliveri.info> - 1.8.0-0
- Updated to version 1.8.0 and built for Fedora 39
